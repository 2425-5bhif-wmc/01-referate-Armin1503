...
Bevor die Resource-Klasse implementiert wird, erstellen wir eine **RestConfig**-Klasse, welche dafür sorgt, dass alle REST-Endpunkte in der Anwendung mit **/api** beginnen.
